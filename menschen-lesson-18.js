(function () {
  ...
  const lesson18 = {
    ...
    grammar: [
      ...
      {type: 'Personal pronoun', question: 'Geben Sie ___ den Tee. (er)', answer: 'ihm', explanation: 'Geben takes a dative person; er becomes ihm.'},
      {type: 'Personal pronoun', question: 'Ich empfehle ___ diese Salbe. (sie, singular)', answer: 'ihr', explanation: 'Empfehlen takes a dative person; singular sie becomes ihr.'},
      {type: 'Personal pronoun', question: 'Bringen Sie ___ bitte ein Glas Wasser. (ich)', answer: 'mir', explanation: 'Bringen takes a dative recipient: mir.'},
      {type: 'Personal pronoun', question: 'Der Arzt gibt ___ ein Rezept. (wir)', answer: 'uns', explanation: 'The dative form of wir is uns.'},
      {type: 'Personal pronoun', question: 'Was fehlt ___? (Sie)', answer: 'Ihnen', explanation: 'Fehlen takes dative; formal Sie becomes Ihnen.'},
      {type: 'Personal pronoun', question: 'Ich gebe ___ einen Tipp. (ihr)', answer: 'euch', explanation: 'The dative form of ihr is euch.'},
      {type: 'Personal pronoun', question: 'Die Tabletten helfen ___ nicht. (sie, plural)', answer: 'ihnen', explanation: 'Helfen takes dative; plural sie becomes ihnen.'},
      {type: 'Pronoun with wehtun', question: 'Der Kopf tut ___ weh. (ich)', answer: 'mir', explanation: 'The person who feels the pain is in the dative.'},
      {type: 'Pronoun with wehtun', question: 'Tut ___ der Hals weh? (du)', answer: 'dir', explanation: 'Du becomes dir with wehtun.'},
      {type: 'Pronoun with wehtun', question: 'Die Füße tun ___ weh. (er)', answer: 'ihm', explanation: 'Er becomes ihm with wehtun.'},
      ...
      {type: 'Contraction', question: 'Ich habe Schmerzen ___ Rücken. (in + der)', answer: 'im', explanation: 'In dem contracts to im for location.'},
      ...
      {type: 'Article after gegen', question: 'Haben Sie etwas gegen ___ Husten? (der)', answer: 'den', explanation: 'Gegen takes accusative; masculine der becomes den.'},
    ...
    sentences: [
      ...
      {type: 'Personal pronoun', question: 'Give him the tea. (formal imperative)', answer: 'Geben Sie ihm den Tee.', explanation: 'Ihm is dative; den Tee is accusative.'},
      {type: 'Personal pronoun', question: 'Give her the ointment. (formal imperative)', answer: 'Geben Sie ihr die Salbe.', explanation: 'Ihr is the feminine dative pronoun.'},
      {type: 'Personal pronoun', question: 'Bring me a glass of water, please. (formal imperative)', answer: 'Bringen Sie mir bitte ein Glas Wasser.', explanation: 'Mir is the dative recipient.'},
      {type: 'Personal pronoun', question: 'I recommend this tea to you. (formal)', answer: 'Ich empfehle Ihnen diesen Tee.', explanation: 'Ihnen is dative; diesen Tee is accusative.'},
      {type: 'Personal pronoun', question: 'The doctor gives me a prescription. (male doctor)', answer: 'Der Arzt gibt mir ein Rezept.', explanation: 'Mir is dative; ein Rezept is accusative.'},
