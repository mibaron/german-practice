(function () {
  ...
  const lesson13 = {
    ...
    grammar: [
      {type: 'Local preposition', question: 'Das Hotel liegt neben ___ Bahnhof. (der)', answer: 'dem', explanation: 'A location answering Wo? takes dative: der Bahnhof → dem Bahnhof.'},
      {type: 'Local preposition', question: 'Die Bank ist vor ___ Post. (die)', answer: 'der', explanation: 'Die becomes der in the dative.'},
      {type: 'Local preposition', question: 'Das Auto steht hinter ___ Hotel. (das)', answer: 'dem', explanation: 'Das becomes dem in the dative.'},
      {type: 'Local preposition', question: 'Die Ampel ist an ___ Kreuzung. (die)', answer: 'der', explanation: 'An answers Wo? here, so it takes dative.'},
      {type: 'Local preposition', question: 'Das Café ist in ___ Stadtmitte. (die)', answer: 'der', explanation: 'In answers Wo? here: in der Stadtmitte.'},
      {type: 'Local preposition', question: 'Der Kiosk steht auf ___ Platz. (der)', answer: 'dem', explanation: 'Auf answers Wo? here: auf dem Platz.'},
      {type: 'Local preposition', question: 'Der Bus fährt unter ___ Brücke durch. (die)', answer: 'der', explanation: 'The route is described with unter + dative.'},
      {type: 'Local preposition', question: 'Sie gehen an ___ Cafés vorbei. (Plural)', answer: 'den', explanation: 'The dative plural article is den; nouns ending in -s take no extra -n.'},
      {type: 'Indefinite article after preposition', question: 'Das Hotel ist neben ___ Bank. (eine)', answer: 'einer', explanation: 'The feminine dative form of eine is einer.'},
      {type: 'Indefinite article after preposition', question: 'Wir warten vor ___ Restaurant. (ein)', answer: 'einem', explanation: 'The neuter dative form of ein is einem.'},
      {type: 'Plural after preposition', question: 'Die Post liegt zwischen ___ Häusern. (die)', answer: 'den', explanation: 'Use den in the dative plural; Häuser also adds -n.'},
      ...
      {type: 'Personal pronoun', question: 'Können Sie ___ helfen? (ich)', answer: 'mir', explanation: 'Helfen takes a dative object: ich → mir.'},
      {type: 'Article after the verb', question: 'Ich suche ___ Bahnhof. (der)', answer: 'den', explanation: 'Suchen takes an accusative object: der Bahnhof → den Bahnhof.'}
    ],
    sentences: [
