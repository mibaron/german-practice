  ...
  const lessons = {
    15: [
      ...
      {type: 'Gap fill', question: 'The view from the window. Fill the gaps.',
        text: 'Der Blick aus dem Fenster [gefällt|gefallen] [uns|wir] gut, man sieht die Berge und den [See|lake].',
        explanation: 'Wir becomes uns in the dative.'},
      {type: 'Gap fill', question: 'Whose bike is it? Fill the gaps.',
        text: 'Wem [gehört|gehören] das Fahrrad vor der Werkstatt? – Es gehört [meinem|mein] Nachbarn.',
        explanation: 'Gehören takes dative; Nachbar adds -n in the dative.'},
      {type: 'Gap fill', question: 'Help the tourists. Fill the gaps.',
        text: 'Die Touristen suchen die Jugendherberge. Kannst du [ihnen|sie (plural)] [helfen|to help]?',
        explanation: 'Helfen takes dative; plural sie becomes ihnen.'},
      {type: 'Gap fill', question: 'City or countryside? Fill the gaps.',
        text: 'Auf dem Land ist das Leben [ruhig|quiet], in der Stadt ist es [lebendig|lively]. Beides gefällt [ihr|sie (singular)].',
      ...
      {type: 'Gap fill', question: 'Thank a friend for a tip. Fill the gaps.',
        text: 'Ich danke [dir|du] für den Tipp: Die Kneipe am Markt [gefällt|gefallen] [mir|ich] wirklich gut.',
      ...
      {type: 'Text', question: 'Complete the blog post about a favourite neighbourhood.',
        text: 'Mein Lieblingsviertel\n\nIch wohne seit drei Jahren in Giesing und das Viertel [gefällt|gefallen] mir jeden Tag mehr. Morgens kaufe ich Brot beim Bäcker, der Laden gehört [einer|eine] netten Familie. Am Nachmittag sitze ich gern [im|in + der] Park und abends treffe ich meine Freunde in der [Kneipe|pub]. Viele Einwohner sagen: Hier ist das Leben [lebendig|lively], aber nicht zu laut. Schreibt [mir|ich] einen Kommentar: Wie gefällt [euch|ihr] euer Viertel?',
      ...
      {type: 'E-mail', question: 'Complete the e-mail about the new flat.',
        text: 'Hallo Jana,\n\nwir sind jetzt in unserer neuen Wohnung in Hamburg. Das Viertel gefällt [uns|wir] sehr gut. Aus dem Fenster [sehen|sehen, wir-Form] wir den Fluss und einen kleinen Park. Neben dem Haus gibt es einen [Kindergarten|kindergarten] für Leo und einen Friseur. Nur der Lärm von der Straße gefällt Tom [nicht|negation]. Komm uns bald besuchen, die Jugendherberge [liegt|liegen] direkt am See!\n\nLiebe Grüße\nMia',
    ...
    16: [
      ...
      {type: 'Gap fill', question: 'Find a time for an appointment. Fill the gaps.',
        text: 'Haben Sie am Dienstag [um|preposition: clock time] zehn Uhr Zeit? – Nein, aber [am|an + der] Mittwoch [passt|passen] es mir gut.',
      ...
      {type: 'Gap fill', question: 'Ask for help at the reception. Fill the gaps.',
        text: 'Können Sie [mir|ich] bitte helfen? Die Heizung ist [kaputt|adjective: broken] und das Zimmer ist sehr [kalt|adjective: cold].',
      ...
      {type: 'Gap fill', question: 'Say where you are and when you come. Fill the gaps.',
        text: 'Ich bin gerade [beim|bei + der] Arzt und komme [in|preposition: future point in time] zehn Minuten [vorbei|vorbeikommen].',
    ...
    17: [
      ...
      {type: 'Gap fill', question: 'Plans after school. Fill the gaps.',
        text: 'Nach dem Abitur [wollen|wollen, plural] meine Freunde [im|in + das] Ausland studieren, aber ich mache lieber eine [Ausbildung|vocational training].',
    ...
    18: [
      ...
      {type: 'Gap fill', question: 'The knee. Fill the gaps.',
        text: 'Tut [dir|du] das Knie noch weh? – Ja, ich [soll|sollen, ich-Form] zwei Wochen keinen Sport [machen|to do].',
      ...
      {type: 'Message', question: 'Complete the message to a colleague.',
        text: 'Hallo Nadia,\n\nmir geht es heute gar nicht gut: Mein Rücken [tut|wehtun] seit dem Wochenende [weh|separable part of wehtun] und ich habe Kopfschmerzen. Der Arzt hat [mir|ich] eine Salbe [empfohlen|empfehlen, participle] und sagt, ich [soll|sollen, ich-Form] zwei Tage zu Hause bleiben. Kannst du [mich|ich] bitte beim Chef [entschuldigen|to excuse]? Danke [dir|du]!\n\nOmar',
      ...
      {type: 'Gap fill', question: 'Who gets what? Fill the gaps.',
        text: 'Der Arzt gibt [ihr|sie] ein Rezept und empfiehlt [ihm|er] eine Salbe [gegen|preposition: against] die Schmerzen.',
    ...
    20: [
      ...
      {type: 'Gap fill', question: 'Party and pick-up. Fill the gaps.',
        text: 'Miriam lädt [uns|wir] zur Grillparty ein. Holst du [sie|sie (singular)] vom Bahnhof ab?',
      ...
      {type: 'Gap fill', question: 'Arrange a pick-up. Fill the gaps.',
        text: 'Kannst du [mich|ich] um acht Uhr [abholen|to pick up]? Ich rufe [dich|du] vorher an.',
        explanation: 'Abholen and anrufen take accusative pronouns: mich, dich.'},
      {type: 'Gap fill', question: 'The barbecue. Fill the gaps.',
        text: 'Der Grill ist kalt. [Mach|anmachen, du-imperative] [ihn|er] bitte [an|separable prefix], die Gäste kommen gleich.',
    ...
    23: [
      ...
      {type: 'Gap fill', question: 'Winter in Austria. Fill the gaps.',
        text: 'Wie ist das Wetter [im|in + der] Winter in Österreich? – Es [schneit|schneien] oft und es gibt viel Schnee in den Bergen.',
